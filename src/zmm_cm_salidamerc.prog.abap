...
*  fecha_cont  TYPE mkpf-budat,  "Fecha de contabilizacion
  ...
  um          TYPE mseg-meins,    "unidad de medida
  END OF ty_datos.
...
START-OF-SELECTION.
  ...
  ELSE.
    ...
    IF lv_error EQ 'X'.
      MESSAGE 'Existen registros que no pertenecen al periodo contable ingresado, favor verifique archivo.' TYPE 'E'.
    ENDIF.
      ...
      LOOP AT gt_excel INTO gs_excel.
        ...
        CASE gs_excel-col.
          ...
          WHEN '0011'.
            ...
            IF p_mes+1(2) NE gs_datos-fecha_doc+3(2).
              lv_error = 'X'.
...
FORM llenar_mensajes.
  ...
  READ TABLE messtab INDEX variable_num INTO wa_messtab.  " por que solo me interesa el ultimo mensaje.
  ...
  gs_mensaje-prd_con   = gs_datos_clave-prd_cont. " Unid PRod
