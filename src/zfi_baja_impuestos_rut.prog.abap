...
FROM bset
FOR ALL ENTRIES IN ti_bseg
WHERE bukrs EQ ti_bseg-bukrs
AND belnr EQ ti_bseg-belnr
*Begin of change: ReSQ Correction for Addition ORDER BY PRIMARY KEY 24/12/2019 EY_DES04 ECDK917080 *
*AND gjahr EQ ti_bseg-gjahr.
AND GJAHR EQ TI_BSEG-GJAHR ORDER BY PRIMARY KEY.
*End of change: ReSQ Correction for Addition ORDER BY PRIMARY KEY 24/12/2019 EY_DES04 ECDK917080 *
      IF sy-subrc EQ 0.
        LOOP AT ti_bkpf INTO wa_bkpf.
          LOOP AT ti_bset INTO wa_bset
            ...
            MOVE-CORRESPONDING wa_bset TO wa_salida.

            READ TABLE ti_bseg INTO wa_bseg
